...
/**
 * COMPLETE GAME VALUES - All constants needed for integration
 *
 * This provides ALL the constants referenced by your FastMoveOrdering
 * and UnifiedSearchEngine classes.
 */
public final class GameValues {
    ...
    // === MOVE ORDERING PRIORITIES (for FastMoveOrdering) ===
    ...
    /**
     * MVV-LVA Score calculation (CRITICAL for FastMoveOrdering)
     */
    ...
    /**
     * Simple capture detection (CRITICAL for FastMoveOrdering)
     */
